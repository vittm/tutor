    ...
    <div class="row">
        <div class="col-md-offset-4 col-md-4">
                ...
                <header class="modal-template__header">
                    ...
                    <form class="form-horizontal col-md-12 pd0" role="form" method="POST" action="{{ url('/register') }}" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <input type="hidden" name="money_time" value="0000">
                        <div class="col-md-offset-1 col-md-10 pd0">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} ">
                            <div class="input-text-register">
                                <div class="input-group">
                                  <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                                  <input id="name"  name="name" class="form-control" type="text" value="{{ old('name') }}" placeholder="Họ và Tên">
                                </div>
                                @if ($errors->has('name'))
                                    <span class="help-block">
                                        <strong>Vui lòng điền họ và tên</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                  <span class="input-group-addon" id="basic-addon1">@</span>
                                        <input id="email" name="email" placeholder="Email" class="form-control" type="text" value="{{ old('email') }}">
                                </div>

                                @if ($errors->has('email'))
                                    <span class="help-block">
                                        <strong>Vui lòng điền email</strong>
                                    </span>
                                @endif
                                </div>
                        </div>
                             ...
                             <div class="input-text-register">
                                <div class="input-group">
                                  <span class="input-group-addon" id="basic-addon1"><i class="fa fa-circle-o" aria-hidden="true"></i></span>
                                        <input class="form-control" placeholder="Mật khẩu" id="password" type="password" name="password" >
                                </div>
                                @if ($errors->has('password'))
                                    <span class="help-block">
                                        <strong>Vui lòng điền mật khẩu</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
