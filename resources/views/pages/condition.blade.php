...
<ul class="policy">
  ...
  <li>
  <p><span class="number-main">3</span> Quy định và trách nhiệm của những cá nhân có nhu cầu tìm người dạy (sau đây gọi là “Học Viên”)</p>
    Học Viên chịu trách nhiệm toàn phần trong việc cung cấp thông tin chính xác và trung thực trên website wiis.vn/wiis.edu.vn. <br>
    Thông tin này bao gồm họ tên và số điện thoại.
    Nếu chúng tôi phát hiện bất kỳ sự gian lận, thiếu trung thực hoặc minh bạch nào từ phía Học Viên,
    chúng tôi có quyền đơn phương xóa đơn đăng ký tìm người dạy cũng như tài khoản của Học Viên trên website của chúng tôi để đảm bảo quyền lợi cho những Học Viên khác và Người dạy.
    </p>
  </li>
  <li>
    <p><span class="number-main">4</span> Bảo mật thông tin Khách Hàng và thông tin thanh toán</p>
    <p>4.1. Quy định về bảo mật thông tin của Khách Hàng được thực hiện theo Chính sách bảo mật và chia sẻ thông tin riêng đăng tải trên WiiS.<br>
      4.2. Quy định về bảo mật thông tin thanh toán cho Khách Hàng<br>
      (a) Chính sách giao dịch thanh toán bằng thẻ nội địa và thẻ quốc tế được thực hiện thông qua kết nối với Ngân lượng, đảm bảo tuân thủ các tiêu chuẩn bảo mật của Ngân lượng gồm:<br>
      - Chứng chỉ bảo mật SSL cấp bởi GlobalSign.<br>
      - Hỗ trợ Verified by Visa & 3D-Secure<br>
      (b) Chính sách bảo mật giao dịch trong thanh toán riêng của WiiS áp dụng với khách hàng:<br>
      - Các thông tin thanh toán của Khách Hàng được chúng tôi bảo vệ theo tiêu chuẩn quốc tế với nguyên tắc không ghi nhận các dữ liệu quan trọng của thẻ (số thẻ, họ tên, số CVV) trên hệ thống của WiiS.<br>
      - Truy cập vào hệ thống đều thông qua giao thức HTTPS.<br>
      - Khách hàng có tuỳ chọn sử dụng OTP để truy cập và giao dịch.</p>
  </li>
  <li>
    <p><span class="number-main">5 </span> Bản Quyền</p>
    <p>Tất cả nội dung và hình ảnh trên website www.wiis.vn/www.wiis.edu.vn đều không được sao chép dưới bất kỳ hình thức nào. Nếu chúng tôi phát hiện bất kỳ trường hợp sao chép nào mà không có sự đồng ý của chúng tôi, chúng tôi sẽ nhờ đến pháp luật can thiệp.
      <br>
    </p>
  </li>
  <li>
    <p><span class="number-main">6</span> Giới hạn trách nhiệm</p>
    <p>Tất cả nội dung và hình ảnh trên website www.wiis.vn/www.wiis.edu.vn đều không được sao chép dưới bất kỳ hình thức nào. Nếu chúng tôi phát hiện bất kỳ trường hợp sao chép nào mà không có sự đồng ý của chúng tôi, chúng tôi sẽ nhờ đến pháp luật can thiệp.
    </p>
  </li>
</ul>
