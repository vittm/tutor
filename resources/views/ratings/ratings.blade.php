...
<div class="col-md-12 pd0 content-feedback" style="border-bottom: 1px solid #eeeeee; margint-bottom: 15px;">
  ...
  <div class="col-md-10">
     <div class="col-md-12 pd0">
       <p class="col-md-5 pd0"><strong>{{$value->name}}</strong></p>
       <p class="col-md-7">{{$value->created_at}}</p>
       ...
       <a class="col-md-12 top15"role="button" data-toggle="collapse" href="#collapseExample{{$key}}" aria-expanded="false" aria-controls="collapseExample "> Trả lời </a>
     </div>
    </div>
