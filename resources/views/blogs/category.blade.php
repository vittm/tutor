    ...
    <div class="vote vote--with-upvoters" >
                <div class="vote__buttons" >
                    <div class="vote__upvote" >
                      <a href="" class="button button--upvote" data-reactid=".5.0.0.0"><div class="button--upvote__upvote" >Upvote</div><div class="button--upvote__score " data-reactid="{{ $value->id }}">{{ $value->vote}}</div>
                      ...
                      <div class="vote__downvote"><a href="" class="small muted button--downvote" >Downvote 
                        <input type="hidden" class="idpost" value="{{ $value->id }}">
                        <input type="hidden" class="slug-title" value="{{ $value->title_sym }}">
                      </a></div>
