    ...
    <div class="modal-content col-md-12 pd0">
      <div class="modal-body pd0" style="padding-top:0">
        ...
        <div class="col-md-12">
          ...
          <br>
          <p>Cám ơn @if(Auth::check()) @if(Auth::user()->active == 3)phụ huynh @else bạn @endif @endif {{Auth::user()->name}} đã cho <span style="color:#fcaf00;font-weight:600">Wiis</span> cơ hội được phục vụ.</p>
